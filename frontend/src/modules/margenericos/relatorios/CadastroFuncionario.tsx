    ...
    <>
      ...
      >
        <Row >
          <Col span={100}>
            <h4> Nome Completo </h4>
            <Input style={{ width: 530 }} value={moleculaSelected.descricao} onChange={(e) => setMoleculaSelected({ ...moleculaSelected, descricao: e.target.value, usuario: (parseInt(matricula ? matricula : "0"))  })} placeholder="Máx: 200 Caracteres" />
          </Col>
        </Row>
        <Row style={{ paddingBottom: 20 }}>
          <Col span={100}>
            ...
            <Select
              showSearch
              style={{ width: 530, paddingBottom: 20 }}
              placeholder="Selecione a Molecula"
              optionFilterProp="children"
              onChange={onChange}
              onSelect={(e, l) => setMoleculaSelected({ ...moleculaSelected, descricao: l.title, id: l.value, usuario: (parseInt(matricula ? matricula : "0")) })}>
